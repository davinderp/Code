...
namespace HC.Patient.Web.Controllers
{
    ...
    : base(jsonApiContext, resourceService, loggerFactory)
        ...
        public override async Task<IActionResult> DeleteAsync(int id)
        {
            ...
            var asyncUserFavourite = await base.GetAsync(id);
            var userFavourite = (Entity.UserFavourites)((ObjectResult)asyncUserFavourite).Value;
            userFavourite.IsDeleted = true;
            return await base.PatchAsync(userFavourite.Id, userFavourite);
        }
