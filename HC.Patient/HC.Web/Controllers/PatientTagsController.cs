...
namespace HC.Patient.Web.Controllers
{
    ...
    public class PatientTagsController : CustomJsonApiController<Entity.PatientTags, int>
    {
       ...
       IResourceService<Entity.PatientTags, int> resourceService,
    ...
    : base(jsonApiContext, resourceService, loggerFactory)
        ...
        public override async Task<IActionResult> DeleteAsync(int id)
        {
            ...
            var asyncPatientTags = await base.GetAsync(id);
            var patientTags = (Entity.PatientTags)((ObjectResult)asyncPatientTags).Value;
            patientTags.IsDeleted = true;
            return await base.PatchAsync(patientTags.Id, patientTags);
        }
