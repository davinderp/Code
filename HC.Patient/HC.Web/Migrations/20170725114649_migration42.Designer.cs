...
namespace HC.Patient.Web.Migrations
{
    ...
    [Migration("20170725114649_migration42")]
    partial class migration42
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("HC.Patient.Entity.InsuranceCompanies", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 25, 17, 16, 48, 759, DateTimeKind.Local));
            ...
            modelBuilder.Entity("HC.Patient.Entity.MasterAddressType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("HC.Patient.Entity.MasterAdministrationSite", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 25, 17, 16, 48, 764, DateTimeKind.Local));
            ...
            modelBuilder.Entity("HC.Patient.Entity.MasterCountry", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 25, 17, 16, 48, 756, DateTimeKind.Local));
            ...
            modelBuilder.Entity("HC.Patient.Entity.MasterCPT", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 25, 17, 16, 48, 762, DateTimeKind.Local));
            ...
            modelBuilder.Entity("HC.Patient.Entity.MasterGender", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 25, 17, 16, 48, 761, DateTimeKind.Local));
            ...
            modelBuilder.Entity("HC.Patient.Entity.MasterImmunization", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 25, 17, 16, 48, 763, DateTimeKind.Local));
            ...
            modelBuilder.Entity("HC.Patient.Entity.MasterOccupation", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 25, 17, 16, 48, 757, DateTimeKind.Local));
            ...
            modelBuilder.Entity("HC.Patient.Entity.MasterProgram", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 25, 17, 16, 48, 760, DateTimeKind.Local));
            ...
            modelBuilder.Entity("HC.Patient.Entity.MasterRejectionReason", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 25, 17, 16, 48, 765, DateTimeKind.Local));
            ...
            modelBuilder.Entity("HC.Patient.Entity.PatientAddress", b =>
                {
                    ...
                    b.Property<int?>("MasterCountry1Id");

                    b.Property<int?>("MasterState1Id");
                    ...
                    b.HasIndex("MasterCountry1Id");

                    b.HasIndex("MasterState1Id");
            ...
            modelBuilder.Entity("HC.Patient.Entity.PatientDocuments", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 25, 17, 16, 48, 758, DateTimeKind.Local));
            ...
            modelBuilder.Entity("HC.Patient.Entity.PatientImmunization", b =>
                {
                    ...
                    b.Property<int?>("AdministrationSite");
                    ...
                    b.Property<int?>("VFC_Eligibility");
                    ...
                    b.HasIndex("AdministrationSite");

                    b.HasIndex("CreatedBy");

                    b.HasIndex("DeletedBy");

                    b.HasIndex("ImmunityStatus");
                    ...
                    b.HasIndex("RejectionReason");

                    b.HasIndex("RouteOfAdministration");

                    b.HasIndex("UpdatedBy");

                    b.HasIndex("VFC_Eligibility");
            ...
            modelBuilder.Entity("HC.Patient.Entity.PatientInsuranceDetails", b =>
                {
                    ...
                    b.Property<int?>("InsurancePlanType");
            ...
            modelBuilder.Entity("HC.Patient.Entity.PatientPreference", b =>
                {
                    ...
                    b.Property<int?>("PatientHomeCommPreferences");

                    b.Property<int>("PatientID");

                    b.Property<int?>("PatientOfficeCommPreferences");

                    b.Property<int?>("PreferredLanguage");

                    b.Property<bool?>("ReceiveSMS");

                    b.Property<int?>("ServiceRequested");
                    ...
                    b.HasIndex("PatientHomeCommPreferences");

                    b.HasIndex("PatientID");

                    b.HasIndex("PatientOfficeCommPreferences");

                    b.HasIndex("PreferredLanguage");

                    b.HasIndex("ServiceRequested");
            ...
            modelBuilder.Entity("HC.Patient.Entity.Patients", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 25, 17, 16, 48, 754, DateTimeKind.Local));
            ...
            modelBuilder.Entity("HC.Patient.Entity.PatientAddress", b =>
                {
                    b.HasOne("HC.Patient.Entity.MasterAddressType", "MasterAddressType")
                        .WithMany()
                    ...
                    b.HasOne("HC.Patient.Entity.MasterCountry", "MasterCountry1")
                        .WithMany()
                        .HasForeignKey("MasterCountry1Id");

                    b.HasOne("HC.Patient.Entity.MasterState", "MasterState1")
                        .WithMany()
                        .HasForeignKey("MasterState1Id");
            ...
            modelBuilder.Entity("HC.Patient.Entity.PatientImmunization", b =>
                {
                    ...
                    b.HasOne("HC.Patient.Entity.MasterAdministrationSite", "MasterAdministrationSite")
                        .WithMany()
                        .HasForeignKey("AdministrationSite");
            ...
            modelBuilder.Entity("HC.Patient.Entity.PatientInsuranceDetails", b =>
                {
                    ...
                    b.HasOne("HC.Patient.Entity.MasterType", "MasterType")
                        .WithMany()
                        .HasForeignKey("InsurancePlanType");
            ...
            modelBuilder.Entity("HC.Patient.Entity.PatientPreference", b =>
                {
                    ...
                    b.HasOne("HC.Patient.Entity.MasterPatientCommPreferences", "MasterPatientCommPreferences")
                        .WithMany()
                        .HasForeignKey("PatientHomeCommPreferences");
                    ...
                    b.HasOne("HC.Patient.Entity.MasterPatientCommPreferences", "MasterPatientCommPreferences1")
                        .WithMany()
                        .HasForeignKey("PatientOfficeCommPreferences");
                    ...
                    b.HasOne("HC.Patient.Entity.MasterService", "MasterService")
                        .WithMany()
                        .HasForeignKey("ServiceRequested");
