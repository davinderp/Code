...
namespace HC.Patient.Web.Migrations
{
    ...
    [Migration("20170822062815_migration86")]
    partial class migration86
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("HC.Patient.Entity.OrganizationConnectionstring", b =>
                {
                    ...
                    b.Property<string>("OrganizationDBConnectionstring")
                        .IsRequired()
                        .HasMaxLength(1000);

                    b.Property<string>("OrganizationDBName")
                        .IsRequired()
                        .HasMaxLength(100);
            ...
            modelBuilder.Entity("HC.Patient.Entity.Staff", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("HC.Patient.Entity.OrganizationConnectionstring", b =>
                {
                    ...
                    b.HasOne("HC.Patient.Entity.Organization", "Organization")
                        .WithOne("OrganizationConnectionstring")
                        .HasForeignKey("HC.Patient.Entity.OrganizationConnectionstring", "OrganizationID")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("HC.Patient.Entity.PatientAppointment", b =>
                {
                    ...
                    b.HasOne("HC.Patient.Entity.Staff", "Staff")
                        .WithMany()
            ...
            modelBuilder.Entity("HC.Patient.Entity.PatientImmunization", b =>
                {
                    b.HasOne("HC.Patient.Entity.Staff", "Staff1")
                        .WithMany()
