...
namespace HC.Patient.Web.Migrations
{
    ...
    [Migration("20170724093542_migration35")]
            ...
            modelBuilder.Entity("HC.Patient.Entity.InsuranceCompanies", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 24, 15, 5, 41, 867, DateTimeKind.Local));
            ...
            modelBuilder.Entity("HC.Patient.Entity.MasterAdministrationSite", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 24, 15, 5, 41, 870, DateTimeKind.Local));
            ...
            modelBuilder.Entity("HC.Patient.Entity.MasterCountry", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 24, 15, 5, 41, 865, DateTimeKind.Local));
            ...
            modelBuilder.Entity("HC.Patient.Entity.MasterCPT", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 24, 15, 5, 41, 869, DateTimeKind.Local));
            ...
            modelBuilder.Entity("HC.Patient.Entity.MasterGender", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 24, 15, 5, 41, 868, DateTimeKind.Local));
            ...
            modelBuilder.Entity("HC.Patient.Entity.MasterImmunityStatus", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 24, 15, 5, 41, 871, DateTimeKind.Local));
            ...
            modelBuilder.Entity("HC.Patient.Entity.MasterOccupation", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 24, 15, 5, 41, 866, DateTimeKind.Local));
            ...
            modelBuilder.Entity("HC.Patient.Entity.Patients", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 24, 15, 5, 41, 864, DateTimeKind.Local));
