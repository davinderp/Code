...
namespace HC.Patient.Web.Migrations
{
    ...
    [Migration("20170724063632_migration34")]
            ...
            modelBuilder.Entity("HC.Patient.Entity.InsuranceCompanies", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 24, 12, 6, 31, 693, DateTimeKind.Local));
            ...
            modelBuilder.Entity("HC.Patient.Entity.MasterAdministrationSite", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 24, 12, 6, 31, 696, DateTimeKind.Local));
            ...
            modelBuilder.Entity("HC.Patient.Entity.MasterCountry", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 24, 12, 6, 31, 691, DateTimeKind.Local));
            ...
            modelBuilder.Entity("HC.Patient.Entity.MasterCPT", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 24, 12, 6, 31, 695, DateTimeKind.Local));
            ...
            modelBuilder.Entity("HC.Patient.Entity.MasterGender", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 24, 12, 6, 31, 694, DateTimeKind.Local));
            ...
            modelBuilder.Entity("HC.Patient.Entity.MasterOccupation", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 24, 12, 6, 31, 692, DateTimeKind.Local));
            ...
            modelBuilder.Entity("HC.Patient.Entity.MasterRelationship", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 24, 12, 6, 31, 697, DateTimeKind.Local));
            ...
            modelBuilder.Entity("HC.Patient.Entity.Patients", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2017, 7, 24, 12, 6, 31, 690, DateTimeKind.Local));
