...
namespace HC.Common.Enums
{
    public class CommonEnum
    {
        ...
        public enum MasterDataEnum
        {
            ...
            SOCIALHISTORY,TRAVELHISTORY,ADDRESSTYPE,MASTERCLINICIAN,APPOINTMENTTYPE,LABTESTTYPE, MASTERLONIC, MASTERLABS, TIMETYPE, FREQUENCYTYPE, FREQUENCYDURATIONTYPE,
            MASTERALLERGIES, MASTERREACTION, AUTHORIZEDPROCEDURE, MASTERCUSTOMLABELS, MASTERCUSTOMLABELSCUSTOM
        }
